...
* The ``tests`` folder contains:
  ...
  - Example tests that you should replace with your own meaningful tests (file: ``test_ml_lsmodel_ascat``)
...
* For convenience, the package version is stored in a single place: ``ml_lsmodel_ascat/__version__.py``. For updating the version number, you only have to change this file.
